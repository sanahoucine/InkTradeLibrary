...
if ( ! class_exists( 'HTScript_Notices' ) ){
    class HTScript_Notices{
        ...
        public function __construct(){
            ...
            add_action( 'wp_ajax_htscript_notices', [ $this, 'ajax_dismiss' ] );
        }
            ...
            $scripts = "jQuery(document).ready( function($) {
                $( '.hastech-admin-notice.is-dismissible' ).on( 'click', '.notice-dismiss,.hastech-notice-close', function(e) {
                    ...
                    let noticeWrap = $( this ).parents( '.hastech-admin-notice' ),
                        ...
                        noticeNonce = '".esc_html( wp_create_nonce( 'htscript_notices_nonce' ) )."';
        ...
        private function prepare_notice( $notice_data ){
            ...
            if ( isset( $notice['type'] ) ) {
                ...
                if( $notice['type'] !== 'custom'){
                    ...
                    $notice['dismissible_btn'] = '<button type="button" class="notice-dismiss"><span class="screen-reader-text">'.esc_html__('Dismiss this notice.','ihafs').'</span></button>';
                }
            }
