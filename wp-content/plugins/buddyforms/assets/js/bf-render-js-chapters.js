		jQuery(document.body).on('submit', '#buddyforms_form_chapters', function (event) {
		    var formIsInitialized = jQuery(this).data('initialize');
		    var formSlug = 'chapters';
            ...
            if(BuddyFormsHooks){
                ...
                BuddyFormsHooks.doAction('buddyforms:form:render', ["chapters", ["bootstrap","jQuery","focus"], "buddyforms_ajax_process_edit_post", "post", formTargetStatus]);
            } else {
