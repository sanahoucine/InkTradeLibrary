		jQuery(document.body).on('submit', '#buddyforms_form_books', function (event) {
            ...
            if(BuddyFormsHooks){
                ...
                BuddyFormsHooks.doAction('buddyforms:form:render', ["books", ["bootstrap","jQuery","focus"], "buddyforms_ajax_process_edit_post", "post", formTargetStatus]);
            } else {
