<?php
	...
	if($vw_book_store_second_color != false){
		$vw_book_store_custom_css .='.woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, .wp-block-woocommerce-cart .wc-block-cart__submit-button, .wc-block-components-checkout-place-order-button, .wc-block-components-totals-coupon__button{';
	...
	if($vw_book_store_footer_background_image != false){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='background: url('.esc_attr($vw_book_store_footer_background_image).');background-size:cover;';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_theme_lay = get_theme_mod( 'vw_book_store_footer_template','vw_book_store-footer-one');
    if($vw_book_store_theme_lay == 'vw_book_store-footer-one'){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='';
		$vw_book_store_custom_css .='}';
		$vw_book_store_custom_css .='#footer ul li{';
			$vw_book_store_custom_css .='color:#fff;';
		$vw_book_store_custom_css .='}';

	}else if($vw_book_store_theme_lay == 'vw_book_store-footer-two'){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='background: linear-gradient(to right, #f9f8ff, #dedafa);';
		$vw_book_store_custom_css .='}';
		$vw_book_store_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field,#footer ul li{';
			$vw_book_store_custom_css .='color:#000;';
		$vw_book_store_custom_css .='}';
		$vw_book_store_custom_css .='#footer ul li::before{';
			$vw_book_store_custom_css .='background:#000;';
		$vw_book_store_custom_css .='}';
		$vw_book_store_custom_css .='#footer table, #footer th, #footer td,#footer .search-form .search-field,#footer .tagcloud a{';
			$vw_book_store_custom_css .='border: 1px solid #000;';
		$vw_book_store_custom_css .='}';

	}else if($vw_book_store_theme_lay == 'vw_book_store-footer-three'){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='background: #232524;';
		$vw_book_store_custom_css .='}';
		$vw_book_store_custom_css .='#footer ul li{';
			$vw_book_store_custom_css .='color: #fff;';
		$vw_book_store_custom_css .='}';
	}
	else if($vw_book_store_theme_lay == 'vw_book_store-footer-four'){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='background: #f7f7f7;';
		$vw_book_store_custom_css .='}';
		$vw_book_store_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field,#footer ul li{';
			$vw_book_store_custom_css .='color:#000;';
		$vw_book_store_custom_css .='}';
	...
	else if($vw_book_store_theme_lay == 'vw_book_store-footer-five'){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='background: linear-gradient(to right, #01093a, #2d0b00);';
		$vw_book_store_custom_css .='}';
		$vw_book_store_custom_css .='#footer ul li{';
			$vw_book_store_custom_css .='color: #fff;';
		$vw_book_store_custom_css .='}';
	...
	$vw_book_store_grid_featured_image_border_radius = get_theme_mod('vw_book_store_grid_featured_image_border_radius', 0);
	if($vw_book_store_grid_featured_image_border_radius != false){
		$vw_book_store_custom_css .='.grid-post-main-box .box-image img, .grid-post-main-box .feature-box img{';
			$vw_book_store_custom_css .='border-radius: '.esc_attr($vw_book_store_grid_featured_image_border_radius).'px;';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_grid_featured_image_box_shadow = get_theme_mod('vw_book_store_grid_featured_image_box_shadow',0);
	if($vw_book_store_grid_featured_image_box_shadow != false){
		$vw_book_store_custom_css .='.grid-post-main-box .box-image img, .grid-post-main-box .feature-box img, #content-vw img{';
			$vw_book_store_custom_css .='box-shadow: '.esc_attr($vw_book_store_grid_featured_image_box_shadow).'px '.esc_attr($vw_book_store_grid_featured_image_box_shadow).'px '.esc_attr($vw_book_store_grid_featured_image_box_shadow).'px #cccccc;';
		$vw_book_store_custom_css .='}';
	}

 	/*---------------- Footer Settings ------------------*/

	$vw_book_store_button_footer_heading_letter_spacing = get_theme_mod('vw_book_store_button_footer_heading_letter_spacing',1);
	$vw_book_store_custom_css .='#footer h3, a.rsswidget.rss-widget-title{';
		$vw_book_store_custom_css .='letter-spacing: '.esc_attr($vw_book_store_button_footer_heading_letter_spacing).'px;';
	$vw_book_store_custom_css .='}';

	$vw_book_store_button_footer_font_size = get_theme_mod('vw_book_store_button_footer_font_size','30');
	$vw_book_store_custom_css .='#footer h3, a.rsswidget.rss-widget-title{';
		$vw_book_store_custom_css .='font-size: '.esc_attr($vw_book_store_button_footer_font_size).'px;';
	$vw_book_store_custom_css .='}';

	$vw_book_store_theme_lay = get_theme_mod( 'vw_book_store_button_footer_text_transform','Capitalize');
	if($vw_book_store_theme_lay == 'Capitalize'){
		$vw_book_store_custom_css .='#footer h3{';
			$vw_book_store_custom_css .='text-transform:Capitalize;';
		$vw_book_store_custom_css .='}';
	}
	if($vw_book_store_theme_lay == 'Lowercase'){
	...
	$vw_book_store_footer_heading_weight = get_theme_mod('vw_book_store_footer_heading_weight','600');
	if($vw_book_store_footer_heading_weight != false){
		$vw_book_store_custom_css .='#footer h3, a.rsswidget.rss-widget-title{';
			$vw_book_store_custom_css .='font-weight: '.esc_attr($vw_book_store_footer_heading_weight).';';
		$vw_book_store_custom_css .='}';
	}