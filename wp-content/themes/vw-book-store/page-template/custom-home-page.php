...
<main id="maincontent" role="main">
              ...
              <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
                ...
                <div class="carousel-caption">
                  <div class="inner_carousel">
                    ...
                    <?php } ?>
                    <?php
                      $vw_book_store_button_text = get_theme_mod('vw_book_store_slider_button_text','READ MORE');
                      $vw_book_store_button_link = get_theme_mod('vw_book_store_top_button_url', '');
                      if (empty($vw_book_store_button_link)) {
                        $vw_book_store_button_link = get_permalink();
                      }
                      if ($vw_book_store_button_text || !empty($vw_book_store_button_link)) { ?>
                      <div class="more-btn wow zoomInDown delay-1000" data-wow-duration="2s">
                        <?php if( get_theme_mod('vw_book_store_slider_button_text','READ MORE') != ''){ ?>
                          <a href="<?php echo esc_url($vw_book_store_button_link); ?>">
                          <?php echo esc_html($vw_book_store_button_text); ?>
                            <span class="screen-reader-text"><?php echo esc_html($vw_book_store_button_text); ?></span>
                          </a>
                        <?php } ?>
                      </div>
                    <?php } ?>
  ...
  <?php if( get_theme_mod('vw_book_shop_product_page') != ''){ ?>
