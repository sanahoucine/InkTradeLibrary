...
function vw_book_store_customize_register( $wp_customize ) {
   ...
   $wp_customize->add_setting('vw_book_store_header_my_account_icon',array(
	...
	// font size
	$wp_customize->add_setting('vw_book_store_button_footer_font_size',array(
		'default'=> 30,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_book_store_button_footer_font_size',array(
		'label'	=> __('Footer Heading Font Size','vw-book-store'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	$wp_customize->add_setting('vw_book_store_button_footer_heading_letter_spacing',array(
		'default'=> 1,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_book_store_button_footer_heading_letter_spacing',array(
		'label'	=> __('Heading Letter Spacing','vw-book-store'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	// text trasform
	$wp_customize->add_setting('vw_book_store_button_footer_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback'	=> 'vw_book_store_sanitize_choices'
	));
	$wp_customize->add_control('vw_book_store_button_footer_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Heading Text Transform','vw-book-store'),
		'choices' => array(
      'Uppercase' => __('Uppercase','vw-book-store'),
      'Capitalize' => __('Capitalize','vw-book-store'),
      'Lowercase' => __('Lowercase','vw-book-store'),
	...
	$wp_customize->add_setting('vw_book_store_footer_heading_weight',array(
        'default' => 600,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_book_store_sanitize_choices'
	));
	$wp_customize->add_control('vw_book_store_footer_heading_weight',array(
        'type' => 'select',
        'label' => __('Heading Font Weight','vw-book-store'),
        'section' => 'vw_book_store_footer',
        'choices' => array(
        	'100' => __('100','vw-book-store'),
            '200' => __('200','vw-book-store'),
    ...
    $wp_customize->add_setting('vw_book_store_footer_template',array(
      'default'	=> esc_html('vw_book_store-footer-one'),
      'sanitize_callback'	=> 'vw_book_store_sanitize_choices'	
	  ));
	  $wp_customize->add_control('vw_book_store_footer_template',array(
	          'label'	=> esc_html__('Footer style','vw-book-store'),
	          'section'	=> 'vw_book_store_footer',
	          'setting'	=> 'vw_book_store_footer_template',
	          'type' => 'select',
	          'choices' => array(
	              'vw_book_store-footer-one' => esc_html__('Style 1', 'vw-book-store'),
	              'vw_book_store-footer-two' => esc_html__('Style 2', 'vw-book-store'),
	              'vw_book_store-footer-three' => esc_html__('Style 3', 'vw-book-store'),
	              'vw_book_store-footer-four' => esc_html__('Style 4', 'vw-book-store'),
	              'vw_book_store-footer-five' => esc_html__('Style 5', 'vw-book-store'),
	              )
	  ));
   ...
   $wp_customize->add_setting( 'vw_book_store_excerpt_number', array(
    ...
    $wp_customize->add_setting('vw_book_store_grid_excerpt_settings',array(
        'default' => 'Excerpt',
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_book_store_sanitize_choices'
	));
	$wp_customize->add_control('vw_book_store_grid_excerpt_settings',array(
        'type' => 'select',
        'label' => esc_html__('Grid Post Content','vw-book-store'),
        'section' => 'vw_book_store_grid_layout_settings',
        'choices' => array(
        	'Content' => esc_html__('Content','vw-book-store'),
            'Excerpt' => esc_html__('Excerpt','vw-book-store'),
            'No Content' => esc_html__('No Content','vw-book-store')
        ),
	) );
    ...
    $wp_customize->add_setting( 'vw_book_store_grid_featured_image_border_radius', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_book_store_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_book_store_grid_featured_image_border_radius', array(
		'label'       => esc_html__( 'Grid Featured Image Border Radius','vw-book-store' ),
		'section'     => 'vw_book_store_grid_layout_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'vw_book_store_grid_featured_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_book_store_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_book_store_grid_featured_image_box_shadow', array(
		'label'       => esc_html__( 'Grid Featured Image Box Shadow','vw-book-store' ),
		'section'     => 'vw_book_store_grid_layout_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
...
final class VW_Book_Store_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(new VW_Book_Store_Customize_Section_Pro($manager,'vw_book_store_upgrade_pro_link',array(
			...
			'pro_url'  => esc_url('https://www.vwthemes.com/products/bookstore-wordpress-theme/'),
		)));
