...
VW Book store is a feature-rich, flexible, robust and reliable WordPress theme for book stores, eBook sites, writers, magazines, journalists, editors, authors, publishers, modern online library and online book sellers. 
...
= 1.3.2 =
  -- Added featured image border radius option for grid layout.
  -- Added featured image box shadow option for grid layout.
  -- Update pot file.
...
= 1.3.3 =
  ...
  -- Resolved footer background image issue in customizer.
  -- Update pot file.
...
= 1.3.5 =
  -- Resolved trending product section condition.
