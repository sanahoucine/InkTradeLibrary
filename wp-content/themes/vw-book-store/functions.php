...
function vw_book_store_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/bookstore-wordpress-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-book-store' ) .'</a></span>';
	echo '</div>';
}
...
define('VW_BOOK_STORE_BUY_NOW',__('https://www.vwthemes.com/products/bookstore-wordpress-theme/','vw-book-store'));
...
define('VW_BOOK_STORE_CREDIT',__('https://www.vwthemes.com/products/free-wordpress-book-theme/','vw-book-store'));
...
if ( ! defined( 'VW_BOOK_STORE_GO_PRO_URL' ) ) {
	define( 'VW_BOOK_STORE_GO_PRO_URL', 'https://www.vwthemes.com/products/bookstore-wordpress-theme/');
}
...
if (!function_exists('vw_book_store_edit_link')) :

    function vw_book_store_edit_link($view = 'default')
    {
        global $post;
            edit_post_link(
                sprintf(
                    ...
                    /* translators: %s: Name of current post. Only visible to screen readers */
                        __('Edit <span class="screen-reader-text">%s</span>', 'vw-book-store'),
                        array(
                            'span' => array(
                                'class' => array(),
                            ),
